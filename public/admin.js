  ...
  tbody.innerHTML = posts
    .map((post) => {
      ...
      <tr>
        ...
        <td style="padding: 12px 8px; text-align: center;">${categoryName}</td>
        <td style="padding: 12px 8px; text-align: center;">
          <span class="post-status-badge post-status-${statusClass}">${statusText}</span>
        </td>
        <td style="padding: 12px 8px; text-align: center;">${date}</td>
        <td style="padding: 12px 8px; text-align: center;">${post.view_count || 0}</td>
